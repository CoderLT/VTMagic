...
- (void)updateFrameForSubviews {
    ...
    CGFloat rightItemWidth = _rightNavigatoinItem.frame.size.width > 0 ? size.width - _rightNavigatoinItem.frame.origin.x : 0;
...
- (void)updateFrameForLeftNavigationItem {
    ...
    leftFrame.origin.x -= _navigationItemInset.left;
    leftFrame.origin.y -= _navigationItemInset.bottom;
...
- (void)updateFrameForRightNavigationItem {
    ...
    rightFrame.origin.x -= _navigationItemInset.right;
    rightFrame.origin.y -= _navigationItemInset.bottom;
